...
app.post('/admin/courses', authenticate_admin, (req, res) => {
  try{
    ...
    res.status(500).send({error: "Cannot view the courses at this time"});  
  }
});
...
app.put('/admin/courses/:courseId', authenticate_admin, (req, res) => {
  ...
  try{
    ...
    res.status(500).send({error: "Cannot update the course right now"});  
  }
...
app.post('/users/courses/:courseId', authenticate_user, (req, res) => {
  ...
  try{
    ...
    res.status(500).send({error: "Cannot purchase the course right now"});
  }
